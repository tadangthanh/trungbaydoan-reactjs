...
export const WidgetRightAdmin: React.FC<WidgetRightAdminProps> = ({ setIsEditContent, isEditContent }) => {
    return (
        <div className="card mb-4">
            ...
            <div className="card-body">
                ...
                {isEditContent && <button className="mt-1 btn btn-danger" onClick={() => setIsEditContent(!isEditContent)}>Hủy<i className="ms-1 fa-regular fa-circle-xmark"></i></button>}
